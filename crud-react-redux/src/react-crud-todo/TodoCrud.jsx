...
const TodoCrud = () => {
  ...
  const [edit, setEdit] = useState({ opened: false });
  ...
  const updateItem = async id => {
    ...
    const updatedItem = { ...changedData, item: edit.value.item };
  ...
  useEffect(() => {
    const escKeyCloseModal = e => {
      e.key === 'Escape' && setEdit({ opened: false });
    };
                ...
                >
                  ...
                  <div>
                    <button
                      ...
                      onClick={() =>
                        setEdit({ opened: true, value: { item, id } })
                      }
                    >
                      Edit
                    </button>
        ...
        <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex items-center justify-center">
          ...
          >
            <input
              ...
              type="text"
              autoFocus
              value={edit.value.item}
              onChange={e =>
                setEdit(p => ({
                  ...p,
                  value: { ...p.value, item: e.target.value },
                }))
              }
            />
            <button
              onClick={() => updateItem(edit.value.id)}
              className="bg-green-300 p-2 rounded-xl mr-[5px] text-black"
            >
              Update
            </button>
